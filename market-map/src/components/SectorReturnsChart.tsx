            ...
            return (
              <path
                ...
                onMouseMove={(event) => {
                  ...
                  const tooltipX =
                    rawX + TOOLTIP_GAP + TOOLTIP_WIDTH > bounds.width - TOOLTIP_PADDING
                      ? rawX - TOOLTIP_WIDTH - TOOLTIP_GAP
                      : rawX + TOOLTIP_GAP
                  const tooltipY =
                    rawY + TOOLTIP_GAP + TOOLTIP_HEIGHT > bounds.height - TOOLTIP_PADDING
                      ? rawY - TOOLTIP_HEIGHT - TOOLTIP_GAP
                      : rawY + TOOLTIP_GAP

                  setHoverInfo({
                    x: Math.max(TOOLTIP_PADDING, Math.min(bounds.width - TOOLTIP_WIDTH - TOOLTIP_PADDING, tooltipX)),
                    y: Math.max(TOOLTIP_PADDING, Math.min(bounds.height - TOOLTIP_HEIGHT - TOOLTIP_PADDING, tooltipY)),
                    sector,
                    point: nearest,
