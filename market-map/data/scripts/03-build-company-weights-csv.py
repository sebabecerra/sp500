...
YAHOO_QUOTES_JSON = DATA_ROOT / "extracted/yahoo/quotes.json"
OUTPUT_CSV = DATA_ROOT / "manual/notebook/sp500_companies_wiki_yfinance.csv"
FALLBACK_WEIGHT_CSVS = [
    OUTPUT_CSV,
    MARKET_MAP_ROOT / "public/raw/sp500_market_map_returns.csv",
]
