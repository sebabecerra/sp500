...
CSV_CANDIDATES = [
    REPO_ROOT / "sources/manual/notebook/sp500_market_map_returns.csv",
    REPO_ROOT / "sources/manual/sp500_market_map_returns.csv",
    REPO_ROOT / "sources/manual/notebook/sp500_companies_wiki_yfinance.csv",
    REPO_ROOT / "sources/manual/sp500_companies_wiki_yfinance.csv",
]

WEIGHTS_CANDIDATES = [
    REPO_ROOT / "sources/manual/notebook/sp500_market_map_returns.csv",
    REPO_ROOT / "sources/manual/sp500_market_map_returns.csv",
    REPO_ROOT / "sources/manual/notebook/sp500_market_map_replica.csv",
    REPO_ROOT / "sources/manual/sp500_market_map_replica.csv",
]

WIDE_CANDIDATES = [
    REPO_ROOT / "sources/manual/notebook/sp500_timeseries_15y_wide.csv",
    REPO_ROOT / "sources/manual/sp500_timeseries_15y_wide.csv",
]
