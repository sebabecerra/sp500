...
WEIGHTS_CSV = REPO_ROOT / "sources/manual/notebook/sp500_companies_wiki_yfinance.csv"
WIKI_JSON = REPO_ROOT / "sources/extracted/wikipedia/constituents.json"
TIMESERIES_WIDE_CSV = REPO_ROOT / "sources/manual/notebook/sp500_timeseries_15y_wide.csv"
OUTPUT_CSV = REPO_ROOT / "sources/manual/notebook/sp500_market_map_returns.csv"
