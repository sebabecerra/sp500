...
WEIGHTS_CSV = DATA_ROOT / "manual/notebook/sp500_companies_wiki_yfinance.csv"
WIKI_JSON = DATA_ROOT / "extracted/wikipedia/constituents.json"
TIMESERIES_WIDE_CSV = DATA_ROOT / "manual/notebook/sp500_timeseries_15y_wide.csv"
OUTPUT_CSV = DATA_ROOT / "manual/notebook/sp500_market_map_returns.csv"
