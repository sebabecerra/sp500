...
YAHOO_QUOTES_JSON = REPO_ROOT / "sources/extracted/yahoo/quotes.json"
OUTPUT_CSV = REPO_ROOT / "sources/manual/notebook/sp500_companies_wiki_yfinance.csv"
FALLBACK_WEIGHT_CSVS = [
    OUTPUT_CSV,
    REPO_ROOT / "market-map/public/raw/sp500_market_map_returns.csv",
]
